...
# 🟣 LimeCoin AutoBot /// HPV /// V3.00 🟣

| **Возможности**                                                    | **Поддерживается**  |
|----------------------------------------------------------------|:---------------:|
| **Многофункциональный** — *автоматизирует действия, которые вы обычно выполняете вручную:*<br>**—** *Получение ежедневной награды*;<br>**—** *Улучшение бустов: `Сила клика` и `Лимит энергии`*;<br>**—** *Получение кол-ва бустов и их активация*;<br>**—** *Беспрерывное тапанье под бусты, до истечения дневного лимита*;<br>**—** *Ожидание 24 часа*;<br>**—** *Повторение действий через 24 часа.<br>Все действия выполняются в случайном порядке каждый раз, когда скрипт начинает сбор. Также добавлена пустая функция просмотра рефералов, лиги и профиля для большей правдоподобности* |✅|
...
- **Linux**
  ...
  - ```
    ...
    ```
  - ```
    git clone https://github.com/HPV-CLOUD/LimeCoin
    ```
  - ```
    pip3 install HPV_TEAM_LimeCoin
    ```
- **Windows**
